...
# =====================================================================
# Apna real password yahan dalna
DATABASE_URL = os.environ.get("DATABASE_URL", "postgresql://postgres.zynzkjbwhcoppvykcqrc:[TERA_PASSWORD]@aws-1-ap-southeast-2.pooler.supabase.com:6543/postgres")
